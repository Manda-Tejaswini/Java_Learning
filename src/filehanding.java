...
public class filehanding {
	...
	public static void main(String[] args) {
	  ...
	  public static void AddRecord() throws IOException {
  		...
  		BufferedWriter bw = new BufferedWriter( new FileWriter("E:\\records.txt",true) );
  		Scanner strInput = new Scanner(System.in);
	...
	public static void ViewAllRecord() throws IOException {
	    	BufferedReader br = new BufferedReader( new FileReader("E:\\records.txt") );
	...
	public static void DeleteRecordByID() throws IOException {
	    		...
	    		File tempDB = new File("E:\\records_temp.txt");
	    		File db = new File("E:\\records.txt");
